...
qboolean FS_FileInPathExists(const char *testpath)
{
	...
	//filep = fopen(testpath, "rb"); // Cowcat
...
fileHandle_t FS_SV_FOpenFileWrite( const char *filename ) {
	...
	//fsh[f].handleFiles.file.o = fopen( ospath, "wb" ); // Cowcat
...
//	S_ClearSoundBuffer();
	...
	//fsh[f].handleFiles.file.o = fopen( ospath, "rb" ); // Cowcat
	fsh[f].handleSync = qfalse;
	if (!fsh[f].handleFiles.file.o)
	{
...
//	S_ClearSoundBuffer();
	...
	//fsh[f].handleFiles.file.o = fopen( ospath, "ab" ); // Cowcat
...
int FS_FindVM(void **startSearch, char *found, int foundlen, const char *name, int enableDll)
{
	...
	if(enableDll)
		...
		//Com_sprintf(dllName, sizeof(dllName), "%s.sp." ARCH_STRING DLL_EXT, name); // Cowcat
...
void FS_Restart( int checksumFeed ) {
	...
	if ( Q_stricmp( FS_GetCurrentGameDir(), lastGameDir ) ) {
		//Sys_RemovePIDFile( lastGameDir ); // Cowcat
