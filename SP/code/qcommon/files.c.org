...
int FS_FindVM(void **startSearch, char *found, int foundlen, const char *name, int enableDll)
{
	...
	if(enableDll)
		Q_strncpyz(dllName, Sys_GetDLLName(name), sizeof(dllName)); // Cowcat
		//Com_sprintf(dllName, sizeof(dllName), "%s.sp." ARCH_STRING DLL_EXT, name); //
