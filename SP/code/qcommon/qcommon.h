...
//void    FS_SV_Rename( const char *from, const char *to); // Cowcat
...
// input interface
//
//void IN_Init( void *windowData ); // Cowcat
void IN_Frame( void );
...
//void * QDECL Sys_LoadDll( const char *name, char *fqpath, intptr_t (QDECL **entryPoint)(intptr_t, ...), intptr_t (QDECL *systemcalls)(intptr_t, ...) ); // Cowcat
void * QDECL Sys_LoadDll( const char *name, intptr_t (QDECL **entryPoint)(intptr_t, ...), intptr_t (QDECL *systemcalls)(intptr_t, ...) ); // Cowcat
